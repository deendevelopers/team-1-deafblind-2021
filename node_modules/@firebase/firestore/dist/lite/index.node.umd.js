(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@firebase/app'), require('@firebase/component'), require('@firebase/util'), require('@firebase/logger'), require('util'), require('node-fetch'), require('crypto')) :
    typeof define === 'function' && define.amd ? define(['exports', 'tslib', '@firebase/app', '@firebase/component', '@firebase/util', '@firebase/logger', 'util', 'node-fetch', 'crypto'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.firebase = global.firebase || {}, global.firebase.firestore = {}), global.tslib, global.app, global.component, global.util, global.logger, global.util$1, global.nodeFetch, global.crypto));
}(this, (function (exports, tslib, app, component, util, logger, util$1, nodeFetch, crypto) { 'use strict';
    ...
    var EmulatorCredentialsProvider = /** @class */ (function () {
        ...
        EmulatorCredentialsProvider.prototype.setChangeListener = function (changeListener) {
            this.changeListener = changeListener;
            // Fire with initial user.
